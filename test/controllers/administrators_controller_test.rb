...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, first_name: @administrator.first_name, last_name: @administrator.last_name, office_number: @administrator.office_number, phone_number: @administrator.phone_number, title: @administrator.title } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, first_name: @administrator.first_name, last_name: @administrator.last_name, office_number: @administrator.office_number, phone_number: @administrator.phone_number, title: @administrator.title } }
