...
class CriteriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterium" do
    assert_difference('Criterium.count') do
      post criteria_url, params: { criterium: { description: @criterium.description, title: @criterium.title } }
    end
  ...
  test "should update criterium" do
    patch criterium_url(@criterium), params: { criterium: { description: @criterium.description, title: @criterium.title } }
