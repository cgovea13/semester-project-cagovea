...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { email: @faculty.email, first_name: @faculty.first_name, last_name: @faculty.last_name, office_number: @faculty.office_number, phone_number: @faculty.phone_number, title: @faculty.title } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { email: @faculty.email, first_name: @faculty.first_name, last_name: @faculty.last_name, office_number: @faculty.office_number, phone_number: @faculty.phone_number, title: @faculty.title } }
